...
$string['miuserfield'] = 'User property containing email for movingimage EVP user creation';
...
$string['upload_drag_drop_text'] = 'Drag & drop your video file here, or click to browse';
$string['video_duration'] = 'Duration';
$string['video_published'] = 'Published';
$string['video_views'] = 'Views';
$string['video_plays'] = 'Plays';
$string['connection_settings'] = 'Connection & Account Settings';
$string['player_settings'] = 'Player & Sorting Settings';
$string['sso_settings'] = 'SSO & Keycloak Authentication Settings';
$string['upload_settings'] = 'Upload, Security & Metadata Settings';
