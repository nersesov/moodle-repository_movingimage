...
$string['upload_drag_drop_text'] = 'Video-Datei per Drag & Drop hierhin ziehen oder anklicken zum Durchsuchen';
$string['video_duration'] = 'Länge';
$string['video_published'] = 'Veröffentlicht';
$string['video_views'] = 'Aufrufe';
$string['video_plays'] = 'Wiedergaben';
$string['connection_settings'] = 'Verbindung & Konto-Einstellungen';
$string['player_settings'] = 'Player & Sortierungs-Einstellungen';
$string['sso_settings'] = 'SSO & Keycloak-Authentifizierungseinstellungen';
$string['upload_settings'] = 'Upload-, Sicherheits- & Metadaten-Einstellungen';
